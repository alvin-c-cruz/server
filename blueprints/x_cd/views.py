...
def Home():
	...
	return render_template('x_cd/home.html', cds=cds, date_from=date_from, date_to=date_to)
...
def Add():
	...
	return render_template('x_cd/add.html', form=form, vendors=vendors, accounts=accounts)
...
def Edit(cd_id):
	...
	return render_template('x_cd/edit.html', form=form, vendors=vendors, accounts=accounts)
...
def Print(cd_id):
	...
	return render_template('x_cd/print.html', cd=cd)
...
def View(date_from, date_to):
	...
	return render_template('x_cd/view.html', cds=cds, date_from=date_from, date_to=date_to)
